...
{
    public sealed class UdpServerTeste
    {
        ...
        private UdpServerTeste()
        {
            // do nothing
        }

        public UdpServerTeste(ServerType type, String IpAddress)
        {
            Init(type, IpAddress, 28930);
        }

        public UdpServerTeste(ServerType type, String IpAddress, Int32 Port)
        {
